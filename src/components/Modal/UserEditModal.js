...
import { JUBILACION, MULTIPLICADOR, PORCENTAJE, VALOR_TIEMPO_COMPLETO, estadoCivilOptions, VALOR_TIEMPO_PARCIAL} from '../../constants/constants';
...
const UserEditModal = ({ setShowEditModal, selectedId }) => {
  ...
  console.log('Estado Civil: '+ user.datosPersonales.estadoCivil)

  const letra= user.datosPersonales.estadoCivil;
  return (
    <div className="modal">
            ...
            <div className='form-content'>
              <div className='form-block-modal'>
                ...
                <div className='input-container'>
                  ...
                  <input name='direccion' type='text' defaultValue={user.datosPersonales.direccion} />
                </div>
              </div>
              <div className='form-block-modal'>
                <div className='input-container'>
                ...
                <div className='input-container'>
                  ...
                  <input name='telefono' type='text' defaultValue={user.datosPersonales.telefono} />
                </div>
              </div>
              <div className='form-block-modal'>
                <div className='input-container'>
            ...
            <div className='form-content'>
              ...
              <div className='form-block-modal'>
                ...
                <div className='input-container'>
                  ...
                  <input style={{backgroundColor:'#E4E7E6'}} name='puesto' type='text' defaultValue={user.rol} />
                </div>
              </div>
              <div className='form-block-modal'>
                <div className='input-container'>
            ...
            <div className='form-content'>
              ...
              <div className='form-block-modal'>
                <div className='input-container'>
                  ...
                  <input name='modalidadHoraria' type='text' defaultValue={modalidadHoraria} />
                </div>
                <div className='input-container'>
              ...
              <div className='form-block-modal'>
                <div className='input-container'>
                  ...
                  <input style={{backgroundColor:'#E4E7E6'}} type='text' id='cargaHoraria' readOnly defaultValue={cargaHoraria} />
                </div>
                <div className='input-container'>
                  <label htmlFor=""> Fondo de pensiones: </label>
                  <input  type='text' id='fondoPensiones' defaultValue={fondoPensiones} />
                </div>
              ...
              <div className='form-block-modal'>
                <div className='input-container'>
                  ...
                  <input style={{backgroundColor:'#E4E7E6'}} type='number' id='pagoPorHora' step="any" min={0} readOnly defaultValue={user.datosPlanilla.pagoHora} />
                </div>
                {
                  fondoPensiones === 'AFP' &&
                  <div className='input-container'>
