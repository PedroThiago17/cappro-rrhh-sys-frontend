  ...
  return (
    <div className='fp-container'>
      ...
      <div className='fp-content'>
        ...
        <p> 2. Abrir el Símbolo del sistema de Windows o Terminal en caso de tener Mac </p>
        <p> 3. Pegar el texto copiado según el sistema operativo de su computadora </p>
      </div>
    </div>
  )
}
